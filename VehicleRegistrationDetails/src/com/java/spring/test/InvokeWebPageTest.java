...
public class InvokeWebPageTest {
	...
	// @FindBy annotation is used to find web elements
    ...
    private By startNowBtn = By.className("pub-c-button");
    private By vehicleRegNo = By.className("form-control");
    private By continueBtn = By.className("button");
